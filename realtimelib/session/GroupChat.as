...
package realtimelib.session
{
	...
	public class GroupChat extends UserList
	{
		...
		override public function close():void {
			removeEventListener(PeerStatusEvent.CONNECTED, userListUpdate, false);
			removeEventListener(PeerStatusEvent.USER_ADDED, userListUpdate, false);
			removeEventListener(PeerStatusEvent.USER_REMOVED, userListUpdate, false);
			removeEventListener(PeerStatusEvent.USER_IDLE, userListUpdate, false);
			removeEventListener(NetStatusEvent.NET_STATUS, netStatus, false);
